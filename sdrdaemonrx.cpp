...
void usage()
{
    ...
    "Usage: sdrdaemonrx [options]\n"
            ...
            "  srate=<int>    Device sample rate in Hz (default 1000000)\n"
            ...
            "  srate=<int>    Device sample rate in Hz. Depends on Airspy firmware and libairspy support\n"
            ...
            "  freq=<int>     Center frequency of operation in Hz (default 300000000)\n"
            "                 valid values (with XB200): 100k to 3.8G\n"
            "                 valid values (without XB200): 300M to 3.8G\n"
            "  srate=<int>    Device sample rate in Hz. Valid values: 48k to 40M (default 1000000)\n"
            ...
            "  srate=<int>    Sample rate sent in meta data in Hz. Valid values: 8k to 10M (default 5000000)\n"
